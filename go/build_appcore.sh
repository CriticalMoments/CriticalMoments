...
find . -type f ! -iname ".DS_Store" -exec md5 {} \; > ../.go_folder_hashlist
...
rm -r ./appcore/build/Appcore.xcframework
rm ../.go_folder_last_build_hashlist
...
then
    ...
    find . -type f ! -iname ".DS_Store" -exec md5 {} \; > ../.go_folder_last_build_hashlist
    exit 0
else
