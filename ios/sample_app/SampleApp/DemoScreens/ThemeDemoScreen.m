...
-(void) buildSections {
    ...
    [self addSection:@"General" withActions:@[
        resetThemeAction
    ]];
    ...
    [self addSection:@"Banner Message Style" withActions:@[
        bannerFgColorAction,
        banneBgColorAction
    ]];
    ...
    [self addSection:@"Fonts" withActions:@[
        fontNameAction,
        boldFontNameAction,
        fontScaleAction
    ]];
...
-(void) changeBannerFg {
    ...
    [self colorPickerForColor:currentColor withCallback:^(UIColor* color) {
...
-(void) changeFontName {
    UIAlertController* alert = [UIAlertController alertControllerWithTitle:@"Change Font By Name"
                                                                   message:@"Specify a font by name. See iosfonts.com for supported values. An empty resets to default."
...
-(void) changeBoldFontName {
    UIAlertController* alert = [UIAlertController alertControllerWithTitle:@"Change Bold Font By Name"
                                                                   message:@"Specify the 'bold' font by name. See iosfonts.com for supported values. An empty string resets to default."
                                                            preferredStyle:UIAlertControllerStyleAlert];
    [alert addTextFieldWithConfigurationHandler:^(UITextField * _Nonnull textField) {
    ...
    UIAlertAction* defaultAction = [UIAlertAction actionWithTitle:@"OK" style:UIAlertActionStyleDefault
                                                          handler:^(UIAlertAction * action) {
        NSString* newBoldFontName = weakAlert.textFields.firstObject.text;
...
-(void) changeFontScale {
    UIAlertController* alert = [UIAlertController alertControllerWithTitle:@"Change font scale"
                                                                   message:@"Specify a float value to scale UI fonts by (example: 0.9 or 1.3). An empty string or invalid float return to default (1.0)."
                                                            preferredStyle:UIAlertControllerStyleAlert];
    [alert addTextFieldWithConfigurationHandler:^(UITextField * _Nonnull textField) {
